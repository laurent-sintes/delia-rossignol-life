...
- Après ces trois sections, afficher « Offres probablement actives à revérifier » pour les seules annonces `pending`. Ne pas les numéroter avec la sélection, ne pas afficher de score et préciser le motif de revérification ainsi que le lien disponible.
